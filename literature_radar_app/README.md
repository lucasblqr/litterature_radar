...
## Team's interest: unfiltered 60-day journal feeds

The **Team's interest** sidebar now also contains three aggregate feeds:

- **Health Journal**
- **Econ Journal**
- **General Science Journal**

Each feed shows **all papers from the corresponding configured journals whose publication date is within the past 60 days**, ordered newest first. No topic score, keyword, abstract, saved-status, or manual journal filter is applied on these pages. Future-dated issue metadata is excluded from the 60-day window.

To refresh these feeds with new papers, run `update_papers.bat` (configured for 60 days) before starting the app.
